...
#define p_mos			pa.4
#define p_key			pa.3//pa.6

#define p_check			pb.7
#define p_check_ad		PB7
#define p_check_c		pbc.7

#define P_check_temprature	pb.1;
#define P_check_temprature_ad		PB1
#define P_check_temprature_c		pbc.1


#define p_led_r_on		{ pa.6 = 0; }
#define p_led_r_off		{ pa.6 = 1; } 
#define p_led_w_on		{ pb.4 = 0; }
#define p_led_w_off		{ pb.4 = 1; } 
#define p_led_b_on		{ pa.5 = 0; }
#define p_led_b_off		{ pa.5 = 1; } 
#define p_led_g_on		p_led_w_on
#define p_led_g_off		p_led_w_off


#define p_mos_c			pac.4


#define set_check_ad_temprature	{$ pbdier	0b_0000_0000;}
#define set_check_io_temprature	{$ pbdier	0b_0000_0010;}

#define set_check_ad	{$ pbdier	0b_0000_0000;}
#define set_check_io	{$ pbdier	0b_1000_0000;}



#define TEMP_OVER_ADC  2000
...
extern byte temp_sample_flag;
extern byte cnt_ADC;


// byte temp_sample_flag , cnt;
...
i_o_set macro
	...
	pa =	0b_011_0000;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	pac =	0b_0110_0000;				//0:输入		1:输出
	pa =	0b_0110_0000;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	paph =	0b_0100_1000;				//0:关上拉		1:开上拉
   $ padier	0b_0100_1000;				//0:模拟端口	1:数字端口
	
	pb =	0b_0001_0000;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	pbc =	0b_0001_0000;				//0:输入		1:输出
	pb =	0b_0001_0000;				//0:低电平		1:高电平(输出模式下，输出低时自动关上拉)
	pbph =	0b_1000_0000;				//0:关上拉		1:开上拉
  $ pbdier	0b_1000_0000;				//0:模拟端口	1:数字端口
