...
eword math_eword, math_eword_residual,R6;
dword math_dword;
...
{	//math_bytes[5] = math_eword * math_word;
	...
	// } while (--cnt);
		...
		math_dword$0   =       math_bytes[2];   // low byte
		math_dword$1   =       math_bytes[3];
		math_dword$2   =       math_bytes[4];
		math_dword$3   =       0;              // high byte cleared
}
